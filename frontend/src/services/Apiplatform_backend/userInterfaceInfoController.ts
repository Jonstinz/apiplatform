...
/** getUserInterfaceNumById GET /api/userInterfaceInfo/getNum */
export async function getUserInterfaceNumByIdUsingGET(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.getUserInterfaceNumByIdUsingGETParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseUserInterfaceInfo>('/api/userInterfaceInfo/getNum', {
    method: 'GET',
    params: {
      ...params,
    },
