package com.apiplatform.apiplatform_gateway.Model.beans;
...
/**
 *
 * 注：从 ApiRoute 转换成 RouteDefinition 比较麻烦
 * @author zjh
 * @version 1.0
 */
public class ApiRoute implements Serializable {
    ...
    public ApiRoute(String routeId, Integer order, String uri) {
...
/*    public Integer getUpdateUserId() {
    ...
    /**
     * 将 ApiRoute 转换成 Gateway 的 RouteDefinition
     * @return
     */
    public RouteDefinition parseToRoute() throws JSONException {
        ...
        ApiRoute routeForCopy = new ApiRoute("", order, uri);
