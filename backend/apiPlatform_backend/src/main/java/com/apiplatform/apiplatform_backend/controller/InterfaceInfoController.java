...
import com.apiplatform.apiplatform_backend.common.*;
import com.apiplatform.apiplatform_backend.constant.CommonConstant;
import com.apiplatform.apiplatform_backend.exception.BusinessException;
import com.apiplatform.apiplatform_backend.model.dto.interfaceinfo.InterfaceInfoAddRequest;
import com.apiplatform.apiplatform_backend.model.dto.interfaceinfo.InterfaceInfoInvokeRequest;
import com.apiplatform.apiplatform_backend.model.dto.interfaceinfo.InterfaceInfoQueryRequest;
import com.apiplatform.apiplatform_backend.model.dto.interfaceinfo.InterfaceInfoUpdateRequest;
import com.apiplatform.apiplatform_backend.model.enums.InterfaceInfoStatusEnum;
...
import com.apiplatform.apiplatformclient.client.ApiClient;
...
public class InterfaceInfoController {
    ...
    public BaseResponse<Boolean> onlineInterfaceInfo(@RequestBody IdRequest idRequest,
        ...
        String signUrl = oldInterfaceInfo.getUrl();
        String testResult= tempClient.testByGet(signUrl);
        if (!testResult.equals("Normal response")) {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
                                                    HttpServletRequest request) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
        ...
        String accessKey = loginUser.getAccessKey();
        String secretKey = loginUser.getSecretKey();
        Object result = reflectionInterface(ApiClient.class, oldInterfaceInfo.getName(), userRequestParams, accessKey, secretKey);
        //网关拦截对异常处理
        if (result.equals("Error request, response status: 403")){
            throw new BusinessException(ErrorCode.REQUEST_ERROR);
        } else if (result.equals("Error request, response status: 406")) {
            throw new BusinessException(ErrorCode.NO_NUM_ERROR);
        }
